  ...
  <div class="index">
    ...
    <div class="main">
      ...
      <div class="activeThemeContent">
        ...
        <div class="activeThemeContentItem" v-show="activeIndex == 1">
          <div>
            ...
            <el-checkbox v-model="checkedCc" @change="checkedCcChange" class="checkStyle">跳过开奖动画</el-checkbox>
          </div>
          ...
          <div>
            <el-row type="flex" class="marginBottom30">
              ...
              <el-col :span="12" class="frames textCenter">
                已获得的积分：<span class="figure">{{ detail.act1_reword_point }}</span>&nbsp;/100次
              </el-col>
            </el-row>
            <el-row type="flex" justify="space-around" class="marginBottom30">
              <el-col :span="7">
                <div class="submitBtnGray" @click="showActivity('cc', 1)">冲刺一次</div>
              </el-col>
              <el-col :span="7">
                <div class="submitBtn" @click="showActivity('cc', 3)">冲刺三次</div>
              </el-col>
            </el-row>
            <div class="margiTop20">
              <div class="themeTitle">
                会员参与【极限奔跑吧 / 竞技篮球火 /
                力拔迎胜利】主题所累计积分，每3积分即可抽奖一次获得随机彩金。且可依照最高等级累计积分并于5月27日额外获得一份排位赛神秘彩金奖励，请会员及时点击领取，逾期默认为放弃。
              </div>
              <div class="themeDesc">
        ...
        <div class="activeThemeContentItem" v-show="activeIndex == 2">
          <div>
            ...
            <el-checkbox v-model="checkedTl" @change="checkedTlChange" class="checkStyle">跳过开奖动画</el-checkbox>
          </div>
          ...
          <el-row type="flex" justify="space-around" class="marginBottom30">
            <el-col :span="7">
              <div class="submitBtn" @click="showActivity('tl', 1)">
                <div>投篮一次</div>
              </div>
            </el-col>
            <el-col :span="7">
              <div class="submitBtn" @click="showActivity('tl', 3)">
                <div>投篮三次</div>
              </div>
            </el-col>
          </el-row>
        ...
        <div class="activeThemeContentItem" v-show="activeIndex == 3">
          <div>
            ...
            <el-checkbox v-model="checkedBh" @change="checkedBhChange" class="checkStyle">跳过开奖动画</el-checkbox>
          </div>
          ...
          <el-row type="flex" class="marginBottom30">
            ...
            <el-col :span="14" class="frames ">
              已获得的积分：<span class="figure">{{ detail.act3_reword_point }}</span>&nbsp;/100次
            </el-col>
          </el-row>
          <el-row type="flex" justify="space-around" class="marginBottom30">
            <el-col :span="7">
              <div class="submitBtn" @click="showActivity('bh', 1)">
                <div>拔河一次</div>
              </div>
            </el-col>
            <el-col :span="7">
              <div class="submitBtn" @click="showActivity('bh', 3)">
                <div>拔河三次</div>
              </div>
            </el-col>
          </el-row>
        ...
        <div class="activeThemeContentItem pwItem" v-show="activeIndex == 4">
          <el-row class="margin20" type="flex" justify="space-around" align="middle">
            ...
            <el-col :span="12">
              <div>
                <el-checkbox v-model="checkedCj" @change="checkedCjChange" class="checkStyle">跳过开奖动画</el-checkbox>
              </div>
            </el-col>
          </el-row>
          <el-row type="flex" justify="space-between" align="middle" class="marginBottom20">
            <el-col :span="12" class="frames noMargin">
              <div>累计积分：50 积分/{{ detail.total_point }}积分</div>
            </el-col>
            <el-col :span="12" class="frames noMargin">
          ...
          <el-row type="flex" align="middle" class="marginBottom20">
            <el-col :span="12" class="textCenter">
              <img src="../assets/image/rank-1.png" alt="" class="awardPic-rank">
              <!-- <img src="../assets/image/rank-2.png" alt="">
                  <img src="../assets/image/rank-3.png" alt="">
                  <img src="../assets/image/rank-4.png" alt="">
                  <img src="../assets/image/rank-5.png" alt=""> -->
            </el-col>
            <el-col :span="12" class="textCenter">
          ...
          <el-row type="flex" align="middle" class="marginBottom20">
            <el-col :span="12" class="textCenter">
              <div class="btn">领取排位赛奖励</div>
            </el-col>
            <el-col :span="12" class="textCenter">
              <el-row type="flex" justify="space-between" align="middle">
                <el-col :span="12" class="textCenter">
                  <div class="btn" @click="showActivity('cj', 1)">
                    <div>抽奖一次</div>
                  </div>
                </el-col>
                <el-col :span="12" class="textCenter">
                  <div class="btn" @click="showActivity('cj', 5)">
                    <div>抽奖五次</div>
                  </div>
                </el-col>
              </el-row>
      ...
      <div class="tableData" v-show="activeIndex == 1 || activeIndex == 2 || activeIndex == 3">
        <div class="tableHead el-row">
          <div class="el-col el-col-12">活动条件</div>
          <div class="el-col el-col-12">活动奖励</div>
        </div>
        <div class="tableBody el-row">
          <div class="el-col el-col-12">
            每累计有效存款1,520元</div>
          <div class="el-col el-col-12">随机彩金+1点积分
          </div>
        </div>
      </div>
    ...
    <el-dialog :visible.sync="dialogVisible" width="100%" :before-close="handleClose" class="rewardIframe"
      ...
      <!-- 冲刺 -->
      <div v-show="activityDialogType == 'cc' && !elementVisibleCc">
      ...
      <!-- 拔河 -->
      <div v-show="activityDialogType == 'bh' && !elementVisibleBh">
        <img src="../assets/image/alert.png" alt="">
        <div class="dialogContent">
          <div class="rewardIframeTitle">恭 喜 您 获 得</div>
          <div class="rewardIframeContent">
      ...
      <!-- 投篮 -->
      <div v-show="activityDialogType == 'tl' && !elementVisibleTl">
        <img src="../assets/image/alert.png" alt="">
        <div class="dialogContent">
          <div class="rewardIframeTitle">恭 喜 您 获 得</div>
          <div class="rewardIframeContent">
      ...
      <!-- 抽奖 -->
      <div v-show="activityDialogType == 'cj' && !elementVisibleCj">
        <img src="../assets/image/alert.png" alt="">
        <div class="dialogContent">
          <div class="rewardIframeTitle">恭 喜 您 获 得</div>
          <div class="rewardIframeContent">
      ...
      <div class="recordContent">
        ...
        <div class="recordTable">
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="address" label="活动奖品内容" align="center">
            </el-table-column>
          </el-table>
        </div>
      </div>
...
import { getActivityIndex, getPrize, recordHistory } from '@/api'
export default {
  data() {
    return {
      checked: false,
  ...
  methods: {
    ...
    showActivity(type, count) {
      ...
      if (type == 'cc') {
        if (!this.checkedCc) {
          setTimeout(() => this.elementVisibleCc = false, 3000)
        }
        act = 1
      } else if (type == 'tl') {
        if (!this.checkedTl) {
          setTimeout(() => this.elementVisibleTl = false, 3000)
        }
        act = 2
      } else if (type == 'bh') {
        if (!this.checkedBh) {
          setTimeout(() => this.elementVisibleBh = false, 3000)
        }
        act = 3
      } else if (type == 'cj') {
        if (!this.checkedCj) {
          setTimeout(() => this.elementVisibleCj = false, 3000)
        }
        act = 4
      }
      if (act != 4) {
        getPrize({
          ...
          if (res.code == 0) {
            alert('登录即可参与ManBetX万博“助力世界杯”专题活动！')
          }
...
.pic-dh-bh{
  ...
  left calc(50% - 3.19rem)!important
}
.dialogContent{
  width 4.18rem
  height 3rem
