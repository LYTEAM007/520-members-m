  ...
  <div class="index">
    ...
    <div class="main">
      ...
      <div class="activeTheme">
        <div
          @click="changaTabs(1, 'cc')"
          :class="{ activeTab: activeIndex == 1 }"
        >
          <img
            class="activeThemeIcon"
            src="../assets/image/left-pb.png"
            alt=""
          />
          <img
            class="activeThemeArrow"
        ...
        <div
          @click="changaTabs(2, 'tl')"
          :class="{ activeTab: activeIndex == 2 }"
        >
          <img
            class="activeThemeIcon"
            src="../assets/image/left-lq.png"
            alt=""
          />
          <img
            class="activeThemeArrow"
        ...
        <div
          @click="changaTabs(3, 'bh')"
          :class="{ activeTab: activeIndex == 3 }"
        >
          <img
            class="activeThemeIcon"
            src="../assets/image/left-bh.png"
            alt=""
          />
          <img
            class="activeThemeArrow"
        ...
        <div
          @click="changaTabs(4, 'cj')"
          :class="{ activeTab: activeIndex == 4 }"
        >
          <img
            class="activeThemeIcon"
            src="../assets/image/left-pw.png"
            alt=""
          />
          <img
            class="activeThemeArrow"
      ...
      <div class="activeThemeContent">
        ...
        <img
          ...
          v-show="activeIndex == 1"
          src="../assets/image/pb-bg.png"
          alt=""
        />
        <img
          class="activeThemeContentIcon lqBg"
          v-show="activeIndex == 2"
          src="../assets/image/lq-bg.png"
          alt=""
        />
        <img
          class="activeThemeContentIcon bhBg"
          v-show="activeIndex == 3"
          src="../assets/image/bh-bg.png"
          alt=""
        />
        <img
          class="activeThemeContentIcon pwBg"
          v-show="activeIndex == 4"
        ...
        <div class="activeThemeContentItem" v-show="activeIndex == 1">
          ...
          <div class="marginBottom30">
            <el-row type="flex" class="progressText">
              ...
              <el-col :span="12" class="textRight red"> 1,520&nbsp;元 </el-col>
            </el-row>
            <el-row type="flex">
              <el-col :span="24">
                <el-progress
                  :stroke-width="14"
                  :percentage="(detail.current_deposit_amount / 1520) * 100"
                  :color="'#FCAF1E'"
          ...
          <div>
            ...
            <div class="margiTop20">
              ...
              <div class="themeDesc">
                ...
                23:59:59获取，逾期视为放弃。活动中所获随机彩金可持续累计。
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="activeThemeContentItem" v-show="activeIndex == 2">
          <div>
            <img
              ...
              alt=""
              class="activeSectionIconlk"
            />
            <img
              src="../assets/image/people-lq.png"
              alt=""
              class="activeSectionIconPlayer"
            />
            <el-checkbox
              v-model="detail.skip_animei"
              @change="checkedCcChange"
          ...
          <div class="marginBottom30">
            <el-row type="flex" class="progressText">
              ...
              <el-col :span="12" class="textRight red"> 2,888&nbsp;元 </el-col>
            </el-row>
            <el-row type="flex">
              <el-col :span="24">
                <el-progress
                  :stroke-width="14"
                  :percentage="(detail.current_ty_bet_amount / 2888) * 100"
                  :color="'#FCAF1E'"
                  :define-back-color="'#FBECC2'"
                  :show-text="false"
                ></el-progress>
          ...
          <div class="marginBottom30">
            ...
            <el-row type="flex">
              <el-col :span="24">
                <el-progress
                  :stroke-width="14"
                  :percentage="(detail.current_dj_bet_amount / 2888) * 100"
                  :color="'#FCAF1E'"
                  :define-back-color="'#FBECC2'"
                  :show-text="false"
                ></el-progress>
          ...
          <div class="marginBottom30">
            ...
            <el-row type="flex">
              <el-col :span="24">
                <el-progress
                  :stroke-width="14"
                  :percentage="(detail.current_dz_bet_amount / 2888) * 100"
                  :color="'#FCAF1E'"
                  :define-back-color="'#FBECC2'"
                  :show-text="false"
                ></el-progress>
        ...
        <div class="activeThemeContentItem" v-show="activeIndex == 3">
          ...
          <div class="marginBottom30">
            <el-row type="flex" class="progressText">
              ...
              <el-col :span="12" class="textRight red"> 2,088&nbsp;元 </el-col>
            </el-row>
            <el-row type="flex">
              <el-col :span="24">
                <el-progress
                  :stroke-width="14"
                  :percentage="(detail.current_zr_win_amount / 2088) * 100"
                  :color="'#FCAF1E'"
                  :define-back-color="'#FBECC2'"
                  :show-text="false"
                ></el-progress>
          ...
          <div class="marginBottom30">
            ...
            <el-row type="flex">
              <el-col :span="24">
                <el-progress
                  :stroke-width="14"
                  :percentage="(detail.current_qp_win_amount / 2088) * 100"
                  :color="'#FCAF1E'"
                  :define-back-color="'#FBECC2'"
                  :show-text="false"
                ></el-progress>
        ...
        <div class="activeThemeContentItem pwItem" v-show="activeIndex == 4">
            ...
            <el-col :span="12" class="textCenter">
              <el-row type="flex" justify="space-between" align="middle">
                <el-col :span="12" class="textCenter">
                  <div
                    :class="{
                      btnGray: detail.act4_left_time == 0,
                      btn: detail.act4_left_time != 0,
                    }"
                ...
                <el-col :span="12" class="textCenter">
                  <div
                    :class="{
                      btnGray: detail.act4_left_time < 5,
                      btn: detail.act4_left_time >= 5,
                    }"
            ...
            <el-col :span="12" class="textCenter">
              <div
                :class="{
                  ...
                  btnGray:
                    detail.total_point < 50 || detail.act4_reword_prize != 0,
                }"
                @click="getRankReward"
              >
                领取排位赛奖励
          ...
          <div class="themeTitle">
            会员参与主题一至主题三所累计积分，每3积分即可抽奖一次获得随机彩金。且可依照最高等级累计积分并于5月27日额外获得一份排位神秘彩金奖励，请会员及时点击领取，逾期默认为放弃。
          </div>
          <div class="themeDesc">
